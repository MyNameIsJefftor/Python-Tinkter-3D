...
class app(tk.Frame):
    ...
    def draw(self, xoffset = 0) -> None:
        self.canvas.delete("all")
        # self.canvas.create_polygon(50+xoffset,50,75+xoffset,75,75+xoffset,25)
        if self.objects.__len__ == 0:
            return
        for obj in self.objects:
            for pair in obj.pairs:
                    self.canvas.create_polygon(obj.flatPoints[pair[0]], obj.flatPoints[pair[1]], obj.flatPoints[pair[2]], fill="", outline="black")
...
def Main():
    ...
    thirdObject.points = [[25,25,25],[25,25,-25],[-25,25,-25],[-25,25,25],[25,-25,25],[25,-25,-25],[-25,-25,-25],[-25,-25,25]]
